                    ...
                    <div class="container-pluid">
                        <div class="container">
                            <div class="col-md-3" id="ft-about">          
                                <p>WEBSITE bán quần áo Liverpool. </br>
                                Đến với chúng tôi, giao diện bắt mắt, dễ dàng sử dụng. </br>
                            </p>
                            </div>
                            <div class="col-md-3 box-footer" >
                                <h3 class="tittle-footer">Dương Tuấn Phương</h3>
                                <ul>
                                    <li>
                                        <i class="fa fa-angle-double-right"></i>
                                        <a href=""><i></i> MSV : 17020965</a>
                                    </li>
                                    <li>
                                        <i class="fa fa-angle-double-right"></i>
                                        <a href=""><i></i> Ngày sinh : 09/04/1999 </a>
                                    </li>
                                    <li>
                                        <i class="fa fa-angle-double-right"></i>
                                        <a href=""><i></i>  Lớp : Qh2017-CQ-CE </a>
                                    </li>
                                    <li>
                                        <i class="fa fa-angle-double-right"></i>
                                        <a href=""><i></i>ĐH Công Nghệ</a>
                                    </li>
                                    <li>
                                        <i class="fa fa-angle-double-right"></i>
                                        <a href=""><i></i> Tân Tiến-Bắc Giang</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="col-md-3 box-footer">
                                <h3 class="tittle-footer">Đặng Anh Sơn</h3>
                               <ul>
                                    <li>
                                        <i class="fa fa-angle-double-right"></i>
                                        <a href=""><i></i> MSV : </a>
